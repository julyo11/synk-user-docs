...
Endpoint: https://docs.snyk.io/snyk-api/reference/integrations-v1#org-orgid-integrations-integrationid

These examples show how to call the Update existing integration endpoint in the Integrations (v1) API.
...
* password: required, string, JSON key file
* registryBase: required, string, for example, us-east1-docker.pkg.dev, europe-west1-docker.pkg.dev
...
Same as the values listed in the "Set up Broker for an existing integration" example.

#### Credentials needed for the integration you are updating

Same as the credentials listed in the "Set up Broker for an existing integration" example.
...
* Using specific Snyk APIs: https://docs.snyk.io/snyk-api/using-specific-snyk-apis
