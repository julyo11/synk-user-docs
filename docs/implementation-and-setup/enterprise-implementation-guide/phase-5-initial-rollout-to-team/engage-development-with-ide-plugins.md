...
Encouraging your developers to install a [Snyk IDE plugin](/broken/pages/OWQNUoqm7FrjlbC3vcXP) is a key step in improving developer adoption and achieving “shift left,” where developers are more empowered and responsible for fixing issues before they are committed to pull requests or added to builds.
...
* [Eclipse plugin](/broken/pages/j7AOvFyfxRPzSjhsBNUq)
* [JetBrains plugins](/broken/pages/Zh1Cr8JwIgs2j19UcaKh)
* [Visual Studio extension](/broken/pages/uZcKqI9uJub1vgh6ORJd)
* [Visual Studio Code extension](/broken/pages/He24BVK6DaLmWsFeClB4)
...
{% hint style="info" %}
If your Snyk application is hosted on the Snyk EU or AU data center, then you must specify this in your IDE plugin settings with the [URL relevant to your region](/broken/pages/JSacA44jLZg6roCCprQQ#ides-urls).\
See [Regional hosting and data residency](/broken/pages/JSacA44jLZg6roCCprQQ) for more details.
{% endhint %}
