...
The [Provision user endpoints in the Snyk API](/broken/pages/EdUMivhu9WWRzaCG20rk) allow you to grant Organization-level access and permissions to users before they log in to the Snyk platform.
