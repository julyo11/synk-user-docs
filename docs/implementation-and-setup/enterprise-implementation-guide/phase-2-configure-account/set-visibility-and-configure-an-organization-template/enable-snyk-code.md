...
You can use the API endpoint [Enable/Disable the Snyk Code settings for an org](/broken/pages/lkY6vAwR9nt5MMxGU9tW#orgs-org_id-settings-sast) to perform this operation at scale for a large number of organizations.
