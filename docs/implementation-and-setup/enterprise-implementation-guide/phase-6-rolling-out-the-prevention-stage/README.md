...
* Snyk tests on [Pull Request (PR) or Merge Request (MR) Checks](/broken/pages/Cm7hS8N3rVWHMGkV77Qg), available for Open Source, with Snyk Code PR checks.
...
* [Run PR Checks](/broken/pages/yPzhschuRU4VKr1IC41w), which include the option to block new issues.
* [Snyk Delta](/broken/pages/GfGB9yTuQZUJ6uvKYspo) can assist with differences in results at the CLI level.
