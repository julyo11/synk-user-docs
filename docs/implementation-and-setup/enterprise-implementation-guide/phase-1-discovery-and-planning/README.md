...
* How many [Snyk Organizations](/broken/pages/lXO0GbyZzIRVZmIts9nH) do you need?
...
* Are you using [Application context](/broken/pages/02qFHiSuRZqcR8LYBBEs), and are there fields that might be valuable in automating policies with Snyk Essentials?
...
* Read the available examples of [common policies](/broken/pages/2bOYG0BUPNve8C912nBT#use-cases) that can be created using Snyk Essentials.
