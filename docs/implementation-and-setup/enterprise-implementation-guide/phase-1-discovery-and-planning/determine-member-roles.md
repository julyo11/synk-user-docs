...
A key consideration when setting up Snyk is determining if the [pre-defined user roles](/broken/pages/XNksHYxr70heqewL6k3D) align with your needs or if you need to customize roles for your business requirements.
...
The following are the standard pre-defined user roles. See [Pre-defined roles](/broken/pages/XNksHYxr70heqewL6k3D) for more details.
