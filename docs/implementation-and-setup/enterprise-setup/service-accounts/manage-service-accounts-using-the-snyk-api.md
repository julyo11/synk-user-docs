...
You can manage service accounts using the [Snyk REST API](/broken/pages/E6hr71YaBp08RIdLuAoK).
...
`role_id` - The role of the service account, which defines the permissions it has. Available roles can be found using the endpoint [List all roles in a group](/broken/pages/CZh9shBbWqvpO0MmrPTh#group-groupid-roles).
...
**API endpoint:** [Get a list of group service accounts](/broken/pages/E6hr71YaBp08RIdLuAoK#groups-group_id-service_accounts-1)

This [paginated](/broken/pages/EaThAC6g0XHwRKU8Ec1Q#pagination) call returns an array of objects, each describing a service account.

### Create a service account for your Group

**Request**: `POST https://api.snyk.io/rest/groups/{groupId}/service_accounts`

**API endpoint:** [Create a service account for a group](/broken/pages/E6hr71YaBp08RIdLuAoK#groups-group_id-service_accounts)

This call creates a new service account. You pass a `role_id` in the JSON-formatted body of the request, which defines the permissions a service account can use. This role id can be found using the endpoint [List all roles in a group](/broken/pages/CZh9shBbWqvpO0MmrPTh#group-groupid-roles). Roles can be re-used for multiple service accounts.

### Get a service account from your Group

**Request**: `GET https://api.snyk.io/rest/groups/{groupId}/service_accounts/{serviceAccountId}`

**API endpoint:** [Get a group service account](/broken/pages/E6hr71YaBp08RIdLuAoK#groups-group_id-service_accounts-serviceaccount_id-1)
...
**API endpoint:** [Update a group service account](/broken/pages/E6hr71YaBp08RIdLuAoK#groups-group_id-service_accounts-serviceaccount_id)
...
**API endpoint:** [Delete a group service account](/broken/pages/E6hr71YaBp08RIdLuAoK#groups-group_id-service_accounts-serviceaccount_id-secrets)
...
**API endpoint:** [Manage a group service account’s client secret](/broken/pages/E6hr71YaBp08RIdLuAoK#groups-group_id-service_accounts-serviceaccount_id-secrets)
...
**API endpoint:** [Get a list of organization service accounts](/broken/pages/E6hr71YaBp08RIdLuAoK#orgs-org_id-service_accounts-1)
...
**API endpoint:** [Create a service account for an organization](/broken/pages/E6hr71YaBp08RIdLuAoK#orgs-org_id-service_accounts)
...
**API endpoint:** [Get an organization service account](/broken/pages/E6hr71YaBp08RIdLuAoK#orgs-org_id-service_accounts-serviceaccount_id-1)
...
**API endpoint:** [Update an organization service account](/broken/pages/E6hr71YaBp08RIdLuAoK#patch-orgs-org_id-service_accounts-serviceaccount_id)
...
**API endpoint:** [Delete a service account in an organization](/broken/pages/E6hr71YaBp08RIdLuAoK#orgs-org_id-service_accounts-serviceaccount_id-2)
...
**API endpoint:** [Manage an organization's service account's client secret](/broken/pages/E6hr71YaBp08RIdLuAoK#orgs-org_id-service_accounts-serviceaccount_id-secrets)
