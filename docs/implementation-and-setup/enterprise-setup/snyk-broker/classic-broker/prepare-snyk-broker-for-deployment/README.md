...
When you set up Broker for region other than SNYK-US-01, before you can authenticate you must set environment variables with specific [Broker URLs](/broken/pages/JSacA44jLZg6roCCprQQ#broker-server-urls).\
