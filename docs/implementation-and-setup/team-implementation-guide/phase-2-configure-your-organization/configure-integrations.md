...
There are several [CI/CD integrations](/broken/pages/pRDRUD7zlzkFwSnoufwe) available, or you can use the [Snyk CLI](/broken/pages/eD26UDAHGrXfeHtinya2) as part of your pipeline, in order to have more flexibility in the tests you are running.
...
When configuring pipelines, you can use popular plugins like [`snyk-filter`](/broken/pages/4I0v4shEdeRktgmi0XIK) for advanced filtering.
