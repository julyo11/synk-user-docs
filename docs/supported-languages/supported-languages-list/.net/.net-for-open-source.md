...
For information about the `snyk test` options for use with NuGet, see [Options for NuGet projects in the Test help](/broken/pages/Ekg6VsiCYSmILhHotLJw#options-for-nuget-projects).

For the `snyk monitor` options, see [Options for NuGet projects in the Monitor help](/broken/pages/A8wYIS7YTucNtXMUFdbe#options-for-nuget-projects).
...
See the [Fix your vulnerabilities](/broken/pages/2u7V4rIWmsExCtH82Qqe) page for a general understanding of how Snyk helps you fix Open Source vulnerabilities within your Projects.
