...
You can import JavaScript repositories from any SCM integration supported by Snyk. See [Organization level integrations](/broken/pages/LNOXZ05NnHPVVNO7KcJH). After the import, Snyk analyzes your Projects based on their supported manifest files.
...
* Package registry integrations: [npm Teams and npm Enterprise](/broken/pages/DyFg7P9vgwTHVtRuJguF), [Artifactory Registry setup](/broken/pages/GsFThR8rKBFaOpZ47DMf) and [Nexus Repository Manager setup](/broken/pages/KUvr8I0peKOL3g16CfE9).
* Gatekeeper plugins: [Artifactory Gatekeeper plugin](/broken/pages/THzgyHDijHtAJlWD5H3Y)
