...
* Configure the integration and populate all mandatory fields, including the PAT details. For more details, see the [Integrate GitHub using Snyk Essentials](/broken/pages/ZvXMfSTsBxBdsrDJezQZ#github-integrate-using-snyk-apprisk) page.
...
* Open **Integrations**
* Search and select the GitHub integration
* Configure the integration and populate all mandatory fields, including the PAT details. For more details, see the [GitHub integration settings](/broken/pages/nPkWomOTKXA861LP8KTp#github-integration-settings) page.
