...
The first page of the Inventory provides an overview of your most important repositories and identifies coverage gaps, showing which repos have been tested with Snyk and which have not. See the [Inventory menu](/broken/pages/JbSZZ30RNmpR2HNsl5oO) page for more details.
...
* [Manage assets](/broken/pages/JbSZZ30RNmpR2HNsl5oO)
